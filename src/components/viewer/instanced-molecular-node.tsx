...
const sharedSphereGeometry = new THREE.SphereGeometry(
  1,
  ATOM_SEGMENTS,
  ATOM_SEGMENTS,
);
...
function generateAtomData(node: CompositionNode, baseSize: number): AtomData[] {
      ...
      {instanceData.map(({ colorKey, color, count }) => (
        ...
        >
          <meshStandardMaterial
            ...
            emissive={
              isHovered || isSelected ? color : new THREE.Color("#000000")
            }
