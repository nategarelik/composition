    ...
    return (
      <div className={`w-full h-full flex items-center justify-center bg-gray-900 ${className}`}>
        <div className="text-center p-8 max-w-md">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">WebGL Not Supported</h2>
          <p className="text-gray-400">
            Your browser or device does not support WebGL, which is required for the interactive 3D visualization.
